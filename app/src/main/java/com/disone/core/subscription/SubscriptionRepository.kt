...
class SubscriptionRepository @Inject constructor(
    ...
    /** Fetch server-built transaction (base64). Returns serialized tx bytes for wallet to sign. */
    suspend fun createTransaction(packageKey: String, payerPublicKey: String): Result<ByteArray> {
